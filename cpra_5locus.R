#' CPRA calculator from a sigle table containing 5 locus haplo frequencies.
#'
#' @param list list of excludes(A,B,C,Q,R)
#' @param dt data table of haplo frequencies
#' @param vector ethnic weights
#' 
#' @return vector cpra value
#'
#' @examples
#' \dontrun{
#' CPRA.5L<-function(excludes,DT,ethnic.weights)
#' }
#'  
#' @export
